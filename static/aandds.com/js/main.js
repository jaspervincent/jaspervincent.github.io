...
document.addEventListener("DOMContentLoaded", function(event) {
    // 逐个 try：任何一项初始化失败都不应该拖垮后面的（尤其是导航栏）
    try { addNavbar(); } catch (e) { console.error("addNavbar failed:", e); }
    try { addBackToTopButton(); } catch (e) { console.error("addBackToTopButton failed:", e); }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="/privacy.html">隐私</a></li>
      </ul>
...
<p class="info">
  ...
  <strong>希望这里有你感兴趣的内容</strong>。
    ...
    // 注：body 的显示/隐藏不再在这里控制。
    // 以前在函数末尾手动设 visibility，一旦上面任何一句抛异常，整页就永远是白屏。
    // 现在由 main.css 的 html.js:not(.ready) 配合 aandds-head.html 里的内联脚本管理。
}
